    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header text-center"><h2 class="text-dark text-light" style="font-weight:bold">Invoice #{{ $assignService->invoice_id }}</h2>
                       <div>
                        {{-- <button onclick="window.print()" class="btn btn-primary">Print</button> --}}
                        <a href="" class="btn btn-sm btn-primary float-right" onclick="javascript:window.print();" data-abc="true"><i class="fa fa-print"></i></a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover text-dark">
                        ...
                        <tr>
                            ...
                            <td colspan="6">{{ $assignService->create_at}}</td>
                        </tr>
                     <tr>
