    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header text-dark"><h4>Sales Reports</h4></div>
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group text-dark">
                            ...
                            <div class="form-group">
                                <input type="radio" id="monthly" name="sales" value="monthly">
                                <label for="monthly">Monthly</label>
                            
                                <input type="radio" id="yearly" name="sales" value="yearly">
